...
@Unique(
        name = "Vehiculo__marca__UNQ", members = { "marca" }
)
@Queries({
        @Query(
                name = Vehiculo.NAMED_QUERY__FIND_BY_MARCA,
                value = "SELECT " +
                        "FROM domainapp.modules.simple.dom.so.Vehiculo " +
                        "WHERE marca == :marca"
        )
})
...
public class Vehiculo implements Comparable<Vehiculo> {
    ...
    static final String NAMED_QUERY__FIND_BY_MARCA = "Vehiculo.findByMarca";
